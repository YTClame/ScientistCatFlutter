...
class Rasp extends StatefulWidget {
  Rasp(Function _lkAdapterCallback, Function _createCallback) {
    _rs = new _RaspState(_lkAdapterCallback, _createCallback);
  }
...
class _RaspState extends State<Rasp> {
  ...
  _RaspState(this._lkAdapterCallback, this._createCallback);
      ...
      child: new SingleChildScrollView(
        child: new Column(
          children: [
            ...
            new OneDayRasp("Понедельник", _monday, addRaspElem, updateRasp),
            new OneDayRasp("Вторник", _tuesday, addRaspElem, updateRasp),
            new OneDayRasp("Среда", _wednesday, addRaspElem, updateRasp),
            new OneDayRasp("Четверг", _thursday, addRaspElem, updateRasp),
            new OneDayRasp("Пятница", _friday, addRaspElem, updateRasp),
            new OneDayRasp("Суббота", _saturday, addRaspElem, updateRasp),
            new OneDayRasp("Воскресенье", _sunday, addRaspElem, updateRasp),
            new Container(height: 20,),
            MainTextCenter("Дополнительное расписание по датам:"),
            new AdditionalRasp(_anotherDayParsed, addRaspElem, updateRasp),
